...
public class FilterValues {
	...
	public  static DataCrash[] day_of_week = {
	...
	public  static DataCrash[] age = {
			young,adult,elder
	};

	public  static DataCrash[] light_condition = {
